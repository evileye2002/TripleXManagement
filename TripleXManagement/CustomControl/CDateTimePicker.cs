...
namespace TripleXManagement.CustomControl
{
    public class CDateTimePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.denied_20px;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Properties.Resources.denied_20px;
                else calendarIcon = Properties.Resources.denied_20px1;
                this.Invalidate();
            }
        }
